...
fibro_all_diet <- AddMetaData(fibro_all_diet, metadata = hbca_dcis_ibc.integrated.b1.b2.clean.cellanno.met.tis.t)
VlnPlot(fibro_all_diet, 'TGFB1', split.by = 'tissue_type', pt.size = 0)
